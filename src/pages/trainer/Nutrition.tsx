    ...
    <div className="max-w-5xl">
      ...
      <div className="relative h-48 rounded-2xl overflow-hidden mb-8">
        <div
          ...
          style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1490645935967-10de6ba17061?w=1600&q=80)' }}
        />
        ...
        <div className="relative h-full flex flex-col justify-end px-8 pb-6">
          <h1 className="font-bebas text-4xl text-white tracking-wide">Nutrition</h1>
          <p className="font-barlow text-sm text-white/50 mt-1">Build and assign meal plans for your clients</p>
        </div>
      ...
      <div className="bg-[#1C1C1E] rounded-xl border border-[#2C2C2E] p-16 text-center">
        ...
        <p className="font-barlow text-sm text-white/30">Nutrition planning is being built out.</p>
      </div>
    </div>
  )
}
